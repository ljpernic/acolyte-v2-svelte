<script lang="ts">
  ...
  const path: string = '/pages/presses';
  const description: string = 'Presses on the Acolyte Submission System';
  const title: string = 'Presses - Acolyte Submission System';
  const subtitle: string = 'Presses';
...
<main class="mx-auto bg-gray-50 dark:bg-gray-900">
  <div class="container mx-auto px-4 pt-24 md:pt-32 lg:px-0 dark:bg-gray-900">
    <h1 class="mb-3 text-3xl font-bold text-gray-900 sm:text-4xl sm:leading-none sm:tracking-tight dark:text-white">Presses Using the Acolyte Submission System</h1>
