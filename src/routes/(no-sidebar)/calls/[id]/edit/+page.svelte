<script lang="ts">
  ...
  let anonymousSubmissions = data.call.anonymousSubmissions;
  let description = data.call.description;

  // Initialize form fields with existing call data (with fallbacks)
  let formFields = {
    piecesPerSubmission: {
      visible: data.call.formFields?.piecesPerSubmission?.visible ?? true,
      required: data.call.formFields?.piecesPerSubmission?.required ?? true,
      allowMultiple: data.call.formFields?.piecesPerSubmission?.allowMultiple ?? false,      
      min: data.call.formFields?.piecesPerSubmission?.min ?? 1,
      max: data.call.formFields?.piecesPerSubmission?.max ?? 3,
      description: data.call.formFields?.piecesPerSubmission?.description ?? "Submit up to 3 pieces with titles",
    },
    submitterName: {
      visible: data.call.formFields?.submitterName?.visible ?? true,
      required: data.call.formFields?.submitterName?.required ?? true,
      allowMultiple: data.call.formFields?.submitterName?.allowMultiple ?? false,
      min: data.call.formFields?.submitterName?.min ?? 1,              
      max: data.call.formFields?.submitterName?.max ?? 3,              
      description: data.call.formFields?.submitterName?.description ?? "Author name(s)",
    },
    submitterEmail: {
      visible: data.call.formFields?.submitterEmail?.visible ?? true,
      required: data.call.formFields?.submitterEmail?.required ?? true,
      description: data.call.formFields?.submitterEmail?.description ?? "Email address",
    },
    wordCount: {
      visible: data.call.formFields?.wordCount?.visible ?? true,
      required: data.call.formFields?.wordCount?.required ?? true,
      min: data.call.formFields?.wordCount?.min ?? null,
      max: data.call.formFields?.wordCount?.max ?? 6000,
      description: data.call.formFields?.wordCount?.description ?? "Word count limits for submissions"
    },
    offerFeedback: {
      visible: data.call.formFields?.offerFeedback?.visible ?? true,
      required: data.call.formFields?.offerFeedback?.required ?? false,
      description: data.call.formFields?.offerFeedback?.description ?? "Would you like feedback on your submission?",
    },
    coverLetter: {
      visible: data.call.formFields?.coverLetter?.visible ?? false,
      required: data.call.formFields?.coverLetter?.required ?? false,
      description: data.call.formFields?.coverLetter?.description ?? "Brief cover letter (optional)",
    },
    fileUpload: {
      visible: data.call.formFields?.fileUpload?.visible ?? true,
      required: data.call.formFields?.fileUpload?.required ?? true,
      description: data.call.formFields?.fileUpload?.description ?? "Upload your submission files",
    }
  };
...
<div class="container mx-auto px-4 py-8 max-w-4xl">
  <div class="flex items-center justify-between mb-6">
    <h1 class="text-3xl font-bold dark:text-gray-300">Edit Call for Submissions</h1>
  ...
  >
    ...
    <div class="bg-white dark:bg-gray-500 dark:text-gray-100 rounded-lg shadow-md p-6">
      ...
      <div class="space-y-4">
        <div>
          ...
          <input 
            ...
            required
            class="w-full border border-gray-300 dark:bg-gray-600 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500"
    ...
    <div class="bg-white dark:bg-gray-500 dark:text-gray-100 rounded-lg shadow-md p-6">
      ...
      <p class="text-gray-600 dark:text-gray-100 mb-6">Configure which fields to show on the submission form and customize their descriptions.</p>
          ...
          <div class="flex items-center justify-between mb-3">
            <div class="flex items-center">
              <input 
                ...
                disabled={true}
                id="name-visible" 
                class="mr-3 text-gray-500 bg-gray-100 border-gray-300 dark:text-gray-900 cursor-default"
              />
              <label for="name-visible" class="font-medium">Submitter name <span class="text-gray-400 dark:text-gray-200">(always required)</span></label>
            </div>
            {#if formFields.submitterName.visible}
              <div class="flex items-center">
                <input 
                  ...
                  class="mr-3 text-gray-500 bg-gray-100 border-gray-300 dark:text-gray-900 cursor-default"
                />
                <label for="name-required" class="text-sm text-gray-600 dark:text-gray-100">
                    Required
                </label>
              </div>
            {/if}
        ...
        <div class="flex items-center justify-between mb-3">
          <div class="flex items-center">
            <input 
              ...
              disabled={true}
              id="pieces-visible" 
              class="mr-3 text-gray-500 bg-gray-100 border-gray-300 dark:bg-gray-500 dark:text-gray-900 cursor-default"
            />
            <label for="pieces-visible" class="font-medium">Pieces/Titles per submission <span class="text-gray-400 dark:text-gray-200">(always required)</span></label>
          </div>
          {#if formFields.piecesPerSubmission.visible}
            <div class="flex items-center">
              <input 
                ...
                class="mr-3 text-gray-500 bg-gray-100 border-gray-300 dark:text-gray-900 cursor-default"
              />
              <label for="pieces-required" class="text-sm text-gray-600 dark:text-gray-100">
                Required
              </label>
            </div>
          {/if}
          ...
          <div class="flex items-center justify-between mb-3">
            <div class="flex items-center">
              <input 
                ...
                class="mr-3 text-gray-500 bg-gray-100 border-gray-300 dark:text-gray-900 cursor-default"
              />
              <label for="email-visible" class="font-medium">Email address <span class="text-gray-400 dark:text-gray-200">(always required)</span></label>
            </div>
            {#if formFields.submitterEmail.visible}
              <div class="flex items-center">
                <input 
                  ...
                  class="mr-3 text-gray-500 bg-gray-100 border-gray-300 dark:text-gray-900 cursor-default"
                />
                <label for="email-required" class="text-sm text-gray-600 dark:text-gray-100">
                    Required
                </label>
              </div>
            {/if}
            ...
            {#if formFields.wordCount.visible}
              <div class="flex items-center">
                <input 
                  ...
                  class="mr-2"
                />
                <label for="wordcount-required" class="text-sm text-gray-600 dark:text-gray-100">Required</label>
              </div>
            {/if}
          </div>
            ...
            {#if formFields.offerFeedback.visible}
              <div class="flex items-center">
                <input 
                  ...
                  class="mr-2"
                />
                <label for="feedback-required" class="text-sm text-gray-600 dark:text-gray-100">
                  Required
                </label>
              </div>
            {/if}
            ...
            {#if formFields.coverLetter.visible}
              <div class="flex items-center">
                <input 
                  ...
                  class="mr-2"
                />
                <label for="cover-required" class="text-sm text-gray-600 dark:text-gray-100">
                  Required
                </label>
              </div>
            {/if}
            ...
            {#if formFields.fileUpload.visible}
              <div class="flex items-center">
                <input 
                  ...
                  class="mr-2"
                />
                <label for="file-required" class="text-sm text-gray-600 dark:text-gray-100">
                  Required
                </label>
              </div>
            {/if}
    ...
    <!-- Anonymous Indicator -->
    <div class="bg-gray-50 rounded-lg p-6 dark:bg-gray-500 dark:text-gray-100">
        {#if anonymousSubmissions}
            <span class="text-xl font-semibold mb-4 rounded">
    ...
    <div class="flex gap-4">
      <button 
        type="submit" 
        disabled={loading}
        class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 dark:bg-blue-700 dark:text-blue-200 dark:md:hover:bg-blue-400 dark:md:hover:text-blue-800 disabled:opacity-35"
      >
        {loading ? 'Saving...' : 'Save Call'}
      </button>
      <a 
        href="/calls" 
        class="bg-gray-300 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-400 dark:bg-gray-500 dark:text-gray-100 dark:md:hover:bg-gray-700"
      >
        Cancel
      </a>
    </div>
